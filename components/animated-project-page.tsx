...
import { ArrowLeft, ExternalLink, Github, Calendar, Users, Clock, Target, Lightbulb, TrendingUp } from "lucide-react"
...
interface AnimatedProjectPageProps {
  project: Project;
}

export function AnimatedProjectPage({ project }: AnimatedProjectPageProps) {
      ...
      >
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {project.liveUrl && (
              <Button variant="outline" size="sm" className="gap-2 hidden md:flex" asChild>
                ...
                >
                  ...
                  <Card className="border-l-4 border-l-primary">
                    <CardContent className="p-8">
                      <div className="mb-4">
                        <h3 className="text-xl font-semibold text-primary mb-2">{project.role}</h3>
                        <p className="text-muted-foreground">
                          As the {project.role}, I was responsible for leading key aspects of the project development.
                        </p>
                      </div>
                      <motion.div
                        initial="hidden"
        ...
        <section className="py-16 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-muted-foreground">Explore more of my work and see how I tackle different challenges</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <Card className="bg-gradient-to-r from-primary/5 to-purple-500/5 border-primary/20 hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                    I'm always excited to take on new challenges and collaborate on innovative projects. Let's discuss
      ...
      <footer className="border-t py-8">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">© 2025 Andy Vo. All rights reserved.</p>
